...
target_jsx.forEach(async (jsx_entry) => {
  ...
  if (mod.default != undefined) {
    ...
    console.log(basename(jsx_entry.path));
    ...
    if (!(await exists(parent))) {
      ...
      console.log(join(relative(Deno.cwd(), jsx_entry.path), jsx_entry.name), renderSSR(() => <Layout title="Site title">{mod.default}</Layout>))
