...
// build/dev/javascript/ex_gleam_lustre_gleez/components/ui/button.mjs
var Neutral = class extends CustomType {
};
...
function flat(color) {
  let _pipe = (() => {
    if (color instanceof Neutral) {
      return "text-neutral bg-neutral/20 hover:enabled:bg-neutral/30";
    } else if (color instanceof Primary) {
      return "text-primary bg-primary/20 hover:enabled:bg-primary/30";
    } else if (color instanceof Secondary) {
      return "text-secondary bg-secondary/20 hover:enabled:bg-secondary/30";
    } else if (color instanceof Success) {
      return "text-success bg-success/20 hover:enabled:bg-success/30";
    } else if (color instanceof Info) {
      return "text-info bg-info/20 hover:enabled:bg-info/30";
    } else if (color instanceof Warning) {
      return "text-warning bg-warning/20 hover:enabled:bg-warning/30";
    } else {
      return "text-danger bg-danger/20 hover:enabled:bg-danger/30";
    }
  })();
  return class$(_pipe);
}
...
// build/dev/javascript/ex_gleam_lustre_gleez/ex_gleam_lustre_gleez.mjs
...
function card(element2) {
  return div(
    toList([class$("flex shadow-lg items-center p-14 rounded-md bg-primary/20")]),
    element2
  );
}
function view(model) {
  ...
  return div(
    toList([class$("flex justify-center my-auto items-center w-full h-screen")]),
    toList([
      card(
        toList([
          button2(
          ...
          p(toList([class$("text-xl mx-2")]), toList([text(count)])),
          button2(
            toList([
              class$("mx-2"),
              flat(new Neutral()),
